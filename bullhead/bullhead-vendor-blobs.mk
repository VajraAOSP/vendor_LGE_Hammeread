...
PRODUCT_COPY_FILES += \
    ...
    vendor/lge/bullhead/proprietary/bin/fingerprintd:system/bin/fingerprintd:lge \
    vendor/lge/bullhead/proprietary/bin/imscmservice:system/bin/imscmservice:lge \
    ...
    vendor/lge/bullhead/proprietary/bin/wcnss_filter:system/bin/wcnss_filter:lge \
    ...
    vendor/lge/bullhead/proprietary/etc/diag/Bullhead_radio-general.cfg:system/etc/diag/Bullhead_radio-general.cfg:lge \
    vendor/lge/bullhead/proprietary/etc/diag/IMS_DS_CM_NAS.cfg:system/etc/diag/IMS_DS_CM_NAS.cfg:lge \
    vendor/lge/bullhead/proprietary/etc/diag/radio_ims.cfg:system/etc/diag/radio_ims.cfg:lge \
    vendor/lge/bullhead/proprietary/etc/diag/radio_wfc.cfg:system/etc/diag/radio_wfc.cfg:lge \
    vendor/lge/bullhead/proprietary/etc/diag/wlan.cfg:system/etc/diag/wlan.cfg:lge \
    ...
    vendor/lge/bullhead/proprietary/lib/hw/audio.primary.msm8992.so:system/lib/hw/audio.primary.msm8992.so:lge \
    vendor/lge/bullhead/proprietary/lib/hw/fingerprint.bullhead.so:system/lib/hw/fingerprint.bullhead.so:lge \
    vendor/lge/bullhead/proprietary/lib/hw/gps.msm8992.so:system/lib/hw/gps.msm8992.so:lge \
    vendor/lge/bullhead/proprietary/lib/soundfx/libfmas.so:system/lib/soundfx/libfmas.so:lge \
    vendor/lge/bullhead/proprietary/lib/libdmengine.so:system/priv-app/DMService/lib/arm/libdmengine.so:lge \
    vendor/lge/bullhead/proprietary/lib/libdmjavaplugin.so:system/priv-app/DMService/lib/arm/libdmjavaplugin.so:lge \
    vendor/lge/bullhead/proprietary/lib/lib_fpc_tac_shared.so:system/lib/lib_fpc_tac_shared.so:lge \
    ...
    vendor/lge/bullhead/proprietary/lib64/hw/audio.primary.msm8992.so:system/lib64/hw/audio.primary.msm8992.so:lge \
    vendor/lge/bullhead/proprietary/lib64/hw/fingerprint.bullhead.so:system/lib64/hw/fingerprint.bullhead.so:lge \
    vendor/lge/bullhead/proprietary/lib64/hw/gps.msm8992.so:system/lib64/hw/gps.msm8992.so:lge \
    vendor/lge/bullhead/proprietary/lib64/lib_fpc_tac_shared.so:system/lib64/lib_fpc_tac_shared.so:lge \
